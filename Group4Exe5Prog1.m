...
% AEM: 9043
% This script tries to fit a function to RH vs temperature
...
for k=1:K
    ...
    figure(4)
    suptitle('Diagnostic plots for poly fits')
...
legend('data',Legend);   
%% Comments 
% Best regression models for temp vs RH is for poly models. Sometimes an
% intriniscally linear model applies as well as a poly model. adjR^2 is not
% that good though.